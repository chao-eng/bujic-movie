...
<template>
  <AlertDialogPortal>
    <AlertDialogOverlay
      ...
      class="data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 bg-black/50 duration-100 supports-backdrop-filter:backdrop-blur-xs fixed inset-0 z-[9998]"
    />
    <AlertDialogContent
