...
import { Folder, File, ArrowLeft, Loader2, ArrowLeftRight, CheckCircle2, Film, Tv, RefreshCw } from 'lucide-vue-next'
...
onMounted(async () => {
  ...
  if (cards.value.length > 0) {
    ...
    initialPath = defaultCard.download_path || '/'
  } else {
